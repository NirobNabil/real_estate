            ...
            <div class="container">
                <div class="row align-items-center" data-local-scroll>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <!-- Card -->
                        <div class="card">
                            <img src="assets/img/home/feature01.jpg" alt="" class="card-image">
                        ...
                        <!-- Card -->
                        <div class="card">
                            <img src="assets/img/home/feature02.jpg" alt="" class="card-image">
                            <div class="card-block">
                                <h5 class="mb-0">Gymnasium</h5>
                                <!-- <p class="text-muted mb-0">Sed ut faucibus est, eu egestas mi.</p> -->
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <!-- Card -->
                        <div class="card">
                            <img src="assets/img/home/feature03.jpg" alt="" class="card-image">
                            <div class="card-block">
                                <h5 class="mb-0">Convention hall</h5>
                                <!-- <p class="text-muted mb-0">Sed ut faucibus est, eu egestas mi.</p> -->
                            </div>
                        ...
                        <!-- Card -->
                        <div class="card">
                            <img src="assets/img/home/feature04.jpg" alt="" class="card-image">
                            <div class="card-block">
                                <h5 class="mb-0">Playing space</h5>
                                <!-- <p class="text-muted mb-0">Sed ut faucibus est, eu egestas mi.</p> -->
                            </div>
        ...
        <div class="panel-objects-list row">
            <div class="col-md-4 col-sm-6">
                ...
                <div class="panel-objects-item">
                    <a href="index.html" class="panel-objects-item-image"><img
                            src="assets/img/home/thumbnail.jpg" alt=""></a>
